...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 08 2021 г., 22:24
...
INSERT INTO `users` (`user_id`, `username`, `password`, `is_active`, `auth_key`, `access_token`, `created_date`, `first_name`, `last_name`, `phone_number`, `email`) VALUES
(1, 'admin', '$2y$10$SgAI4r.LYcSL/l8GoXvuMOGeLMV2MC0FgjFPQYxJgQB2bq8Yi1t1e', 1, NULL, NULL, NULL, 'Админ', 'Админов', '+38 (111) 111-11-11', 'admin@admin.com'),
(2, 'user', '$2y$10$M8u8bqX7Wjl.9UMyC./OneJuo2QFOPCCUiVDSRViBN8Vz3CfG28Q6', 1, NULL, NULL, NULL, 'Юзер', 'Юзеровский', '+38 (222) 222-22-22', 'user@user.ru');
